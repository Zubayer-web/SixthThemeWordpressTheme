...
$args = array(
	...
	'menu_title'                => esc_html__( 'Sixth Options', 'your-textdomain-here' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Sixth Options', 'your-textdomain-here' ),
...
$args['share_icons'][] = array(
	'url'   => '//https://developerjubayer.xyz',
	'title' => 'Visit us on GitHub',
	'icon'  => 'el el-github',
);
$args['share_icons'][] = array(
	'url'   => '//www.facebook.com/jubayer',
	'title' => 'Like us on Facebook',
	'icon'  => 'el el-facebook',
);
$args['share_icons'][] = array(
	'url'   => '//twitter.com/jubayerallh',
	'title' => 'Follow us on Twitter',
	'icon'  => 'el el-twitter',
);
$args['share_icons'][] = array(
	'url'   => '//www.linkedin.com/jubayer',
...
// -------------------> START Basic Fields. ------------------------>
	...
	Redux::set_section($opt_name,array(
		'title'		    =>__('General Options','redux_demo'),
		'id'			=>'General-optiononn',
		'desc'			=>'this is General option you can used',
		'icon'			=>'el el-cog',
	));
...
Redux::set_section($opt_name,array(
		...
		'id'			=>'General-optionnnn',
		'desc'			=>'this is General option you can used',
		'icon'			=>'el el-photo',
		'subsection'	=>true,
		'fields'		=>array(
		      array(
			    'title'			=>__('Header options Text','redux_demo'),
			    'id'			=>'logo-lext',
				'type'			=>'text',
				'default'		=>'Theme',
			  ),
			  array(
			    'title'			=>__('Logo Upload','redux_demo'),
			    'id'			=>'logo-upload',
			    'type'			=>'media',
			    'url'			=>true,
			    'default'		=>array(
			 ...
			 array(
			    'title'			=>__('favicon Upload','redux_demo'),
			    'id'			=>'fav-upload',
			    'type'			=>'media',
			    'url'			=>true,
			    'default'		=>array(
			...
			array(
			    'title'			=>__('Switch visility','redux_demo'),
			    'id'			=>'wp-shitch',
			    'type'			=>'switch',
			    'on'			=>'Show',
			    'off'			=>'Hide',
				...
				array(
			    'title'			=>__('Serach icon visitbaly','redux_demo'),
			    'id'			=>'wp-Serach',
			    'type'			=>'button_set',
			    'options'			=>array(
				     1         =>'Show',
...
Redux::set_section($opt_name,array(
		'title'		    =>__('Footer Options','redux_demo'),
		'id'			=>'footer-optionnnn',
		'desc'			=>'this is Footer option you can used',
		'icon'			=>'el el-photo',
		'subsection'	=>true,
		'fields'		=>array(
		      array(
			    'title'			=>__('Copy Right Text','redux_demo'),
			    'id'			=>'copy-lext',
				'type'			=>'text',
				'default'		=>'C 2021 Sixth, All Rights Reserved.',
			  ),
			 array(
			    'title'			=>__('Privacy Policy Text','redux_demo'),
			    'id'			=>'Privacy-lext',
				'type'			=>'text',
				'default'		=>'Privacy Policy Terms of Service CopyRight Policy',
			  ),
			   array(
			    'title'			=>__('Footer background color','redux_demo'),
			    'id'			=>'color-Footer',
				'type'			=>'color',
				'default'		=>'#666666',
...
Redux::set_section($opt_name,array(
		'title'      => __( 'Background', 'redux_demo' ),
		'id'         => 'design-background',
		'desc'       => __( 'this fields is change your background', 'redux_demo' ),
		'subsection' => true,	
		'icon'       =>'el el-photo',		
		'fields'     => array(
			array(
			    'title'    => __( 'Body Background', 'redux_demo' ),
				'subtitle' => __( 'Body background with image, color, etc.', 'redux_demo' ),
				'id'       => 'opt-background',
				'type'     => 'background',
				'output'   => array(
...
Redux::set_section($opt_name,array(
		'title'      =>__( 'Border', 'redux_demo' ),
		'id'         => 'design-border',
		'desc'       =>__( 'For full documentation on this field, visit: ', 'redux_demo' ),
		'subsection' => true,
		'fields'     => array(
			array(
				'id'       => 'opt-header-border',
				'type'     => 'border',
				'title'    =>__( 'Header Border Option', 'redux_demo' ),
				'subtitle' =>__( 'Only color validation can be done on this field type', 'redux_demo' ),
				'desc'     =>__( 'This is the description field, again good for additional info.', 'redux_demo' ),				
				'output'  => array('.border-custom'),
				'default'  => array(
					'border-color'  => '#1e73be',
					'border-style'  => 'solid',
					'border-top'    => '3px',
				...
				'type'     => 'border',
				'title'    =>__( 'top Border Option', 'redux_demo' ),
				'subtitle' =>__( 'top color validation can be done on this field type', 'redux_demo' ),
				'desc'     =>__( 'This is the description field, again good for additional info.', 'redux_demo' ),				
				'output'  => array('.top-custom'),
				'default'  => array(
					'border-color'  => '#1e73be',
					'border-style'  => 'solid',
					'border-top'    => '3px',
...
Redux::set_section($opt_name,array(
		'title'			=>__('Social Shere','redux_demo'),
		'id'			=>'Social-Shere',
		'desc'			=>'This is Social sheare items you can used',
		'icon'			=>'el el-globe-alt',
		'fields'		=>array(
		    array(			
			   'title' 		=>__('Social Link','redux_demo'),
			   'id' 			=>'Social-link',
			   'type' 			=>'text',
			   'options' 		=>array(
				'facebook' 			=>'Facebook',
...
Redux::set_section($opt_name,array(
     'title'		=>__('Extra CSS','redux_demo'),
     'subtitle'		=>__('Extra CSS Option','redux_demo'),
     'id'			=>'Extra-CSS-Option',
     'desc'			=>'you can right the your ned css',
     'fields'		=>array(
		array(
		   'title'		=>__('Custom CSS','redux_demo'),
		   'subtitle'	=>__('Custom CSS options','redux_demo'),
		   'id'			=>'custom-css',
		   'type'		=>'ace_editor',
		   'mode'		=>'css',
		),	 
